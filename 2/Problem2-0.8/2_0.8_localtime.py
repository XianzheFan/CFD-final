...
# Load grid data
data = np.load('new/grid_circle1.npz')
...
if x_key in data and y_key in data:
    ...
    # plt.savefig('Problem2-0.8-local/error_convergence.png')
    log_err_local_time_step = np.log(rec_max_err[:iter])
    plt.plot(np.arange(len(log_err_local_time_step)), log_err_local_time_step)
    plt.title(f'Log(Error) Convergence - Local Time Step (CFL_max = {CFL_MAX})')
    plt.xlabel('Iteration')
    plt.ylabel('Log(Max Error)')
    plt.savefig('Problem2-0.8-local/log_error_convergence_comparison.png')
    ...
    plt.axis('equal')
    plt.savefig('Problem2-0.8-local/velocity_magnitude_contour.png')
    ...
    plt.axis('equal')
    plt.savefig('Problem2-0.8-local/velocity_magnitude_contour_lines.png')
    ...
    plt.ylim(ylim)
    plt.axis('equal')
    plt.savefig('Problem2-0.8-local/velocity_vectors.png')
    ...
    plt.ylim(ylim)
    plt.axis('equal')
    plt.savefig('Problem2-0.8-local/pressure_contour_lines.png')
    ...
    plt.ylim(ylim)
    plt.axis('equal')
    plt.savefig('Problem2-0.8-local/mesh.png')
    ...
    plt.axis('equal')
    plt.savefig('Problem2-0.8-local/velocity_vectors_cylinder_surface.png')
    
    plt.clf() 
    plt.figure(8)
    plt.plot(theta, p[:, 0])
    plt.title('Pressure Distribution on Cylinder Surface')
    plt.savefig('Problem2-0.8-local/pressure_distribution_cylinder_surface.png')
    ...
    # plt.savefig('Problem2-0.8-local/tangential_velocity_distribution_cylinder_surface.png')
    ...
    # plt.savefig('Problem2-0.8-local/normal_velocity_distribution_cylinder_surface.png')
    ...
    plt.savefig('Problem2-0.8-local/density_distribution_cylinder_surface.png')
    ...
    plt.savefig('Problem2-0.8-local/bernoulli_principle.png')
    ...
    plt.savefig('Problem2-0.8-local/pressure_coefficient.png')
    ...
    plt.axis('equal')
    plt.savefig('Problem2-0.8-local/pressure_contour.png')
    ...
    plt.axis('equal')
    plt.savefig('Problem2-0.8-local/density_contour.png')

   
    np.save('Problem2-0.8-local/u.npy', u)
    np.save('Problem2-0.8-local/v.npy', v)
    np.save('Problem2-0.8-local/y_xi.npy', y_xi)
    np.save('Problem2-0.8-local/x_xi.npy', x_xi)
    np.save('Problem2-0.8-local/y_eta.npy', y_eta)
    np.save('Problem2-0.8-local/x_eta.npy', x_eta)
    ...
    plt.axis('equal')
    plt.savefig('Problem2-0.8-local/density_contour_lines.png')
