...
if x_key in data and y_key in data:
    ...
    plt.savefig('Problem2-0.4/error_convergence.png')
    ...
    plt.axis('equal')
    plt.savefig('Problem2-0.4/velocity_magnitude_contour.png')
    ...
    plt.axis('equal')
    plt.savefig('Problem2-0.4/velocity_magnitude_contour_lines.png')
    ...
    plt.ylim(ylim)
    plt.axis('equal')
    plt.savefig('Problem2-0.4/velocity_vectors.png')
    ...
    plt.ylim(ylim)
    plt.axis('equal')
    plt.savefig('Problem2-0.4/pressure_contour_lines.png')
    ...
    plt.ylim(ylim)
    plt.axis('equal')
    plt.savefig('Problem2-0.4/mesh.png')
    ...
    plt.axis('equal')
    plt.savefig('Problem2-0.4/velocity_vectors_cylinder_surface.png')
    
    plt.clf() 
    plt.figure(8)
    plt.plot(theta, p[:, 0])
    plt.title('Pressure Distribution on Cylinder Surface')
    plt.savefig('Problem2-0.4/pressure_distribution_cylinder_surface.png')
    ...
    plt.savefig('Problem2-0.4/tangential_velocity_distribution_cylinder_surface.png')
    ...
    plt.savefig('Problem2-0.4/normal_velocity_distribution_cylinder_surface.png')
    ...
    plt.savefig('Problem2-0.4/density_distribution_cylinder_surface.png')
    ...
    plt.savefig('Problem2-0.4/bernoulli_principle.png')
    ...
    plt.savefig('Problem2-0.4/pressure_coefficient.png')
    ...
    plt.axis('equal')
    plt.savefig('Problem2-0.4/pressure_contour.png')
    ...
    plt.axis('equal')
    plt.savefig('Problem2-0.4/density_contour.png')
    ...
    plt.axis('equal')
    plt.savefig('Problem2-0.4/streamlines.png')
    ...
    plt.axis('equal')
    plt.savefig('Problem2-0.4/density_contour_lines.png')
